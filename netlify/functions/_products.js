...
const LIVROS=[
{id:"jesus",titulo:"A Luz do Mundo",subtitulo:"A História de Jesus, o Filho de Deus",descricao:"Uma história infantil sobre o nascimento, os ensinamentos, o amor, a morte e a ressurreição de Jesus. Um livro para apresentar às crianças a luz de Deus de forma simples e emocionante.",capa:"AluznoMundo.png",arquivo:"ebook-jesus.pdf",preco:1.90,paginas:18,categoria:"Jesus",destaque:true,ativo:true},
{id:"adao-e-eva",titulo:"Adão e Eva",subtitulo:"No Jardim do Éden",descricao:"A criação, o Jardim do Éden, a escolha de Adão e Eva e a promessa de Deus contadas em linguagem infantil, com ilustrações para colorir.",capa:"AdaoEva.png",arquivo:"ebook-adao.pdf",preco:1.90,paginas:28,categoria:"Antigo Testamento",destaque:true,ativo:true},
{id:"jose",titulo:"José",subtitulo:"O Sonho de um Governador",descricao:"A jornada de José, seus sonhos, as dificuldades, o perdão e a providência de Deus em uma história inspiradora para crianças.",capa:"JoseGovernador.png",arquivo:"ebook-jose.pdf",preco:1.90,paginas:28,categoria:"Antigo Testamento",destaque:true,ativo:true},
...
const COMBO={id:"combo",titulo:"Coleção Pintando a Bíblia",preco:2.90,ativo:true};
